...
public class EntityTests {
    ...
    public void testEquipment() {
        ...
        double actualTax = equipment.calculateTax();
        double actualTotal =  equipment.calculateTotal();
    ...
    public void testLease() {
    	    ...
    	    assertEquals(69037.29, lease.calculateAgreement(), 0.01);  // 50% markup on the amortized cost
    	    assertEquals(1500.00, lease.calculateTax(), 0.01);  // Flat tax applied
    	    assertEquals(70537.29, lease.calculateTotal(), 0.01);  // Total including tax
    ...
    public void testRental() {
        ...
        Rental rental = new Rental(equipment, startTime, endTime);
        ...
        double actualAgreement = rental.calculateAgreement();
        double actualTax = rental.calculateTax();
        double actualTotal = rental.calculateTotal();
    ...
    public void testMaterial() {
        ...
        Material material = new Material(uuid, name, unit, costPerUnit, quantity);
        ...
        double actualTotal = material.calculateTotal();
    ...
    public void testContract() {
        ...
        Company company = new Company("ABC Construction", UUID.randomUUID(), person, address);
        double price = 20000.00;

        // Create an instance of contract
        Contract contract = new Contract(uuid, name, company, price);

        // Expected total value
        double expectedTotal = price;

        // Invoke method to determine the total
        double actualTotal = contract.calculateTotal();
